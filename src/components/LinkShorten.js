    ...
    <div className="App">
      ...
      <div>
        <form method="post" action="" onSubmit={handleSubmit}>
          ...
          />
          <button type="submit"><img src="" alt="send icon" id="send_icon"/></button>
        </form>
          ...
          <div>
            ...
            <span>
              ...
              <CopyToClipboard onCopy={()=>{
                setCopy(true);
              }} text={shortLink.link}>{ !copy ? <img src="" alt="copy icon" width="17px" height="17px"/> : <img src="" alt="copy icon" width="17px" height="17px"/>  }</CopyToClipboard>
